...
import com.dengjia.lib_share_asr.asr_skill.Entity.ActionEntity;
import com.dengjia.lib_share_asr.asr_skill.Entity.BaseEntity;
import com.dengjia.lib_share_asr.asr_skill.Entity.DeviceEntity;
import com.dengjia.lib_share_asr.asr_skill.Entity.PlaceEntity;

import java.util.HashMap;

public class DeviceControlSkill extends BaseSkill {

    private HashMap<Integer, BaseEntity> entityList = new HashMap<>();
